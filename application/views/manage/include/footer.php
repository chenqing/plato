...
<footer id="footer">
	<div class="container">
		<p class="text-center" style="padding:10px;"><span class="icon-envelope">		</span><a href="#" style="text-decoration:none;color:#666;"><b>chenqing663@foxmail.com</b></a></p>
	</div>
</footer>
<!-- footer end -->
<form class="form-horizontal" style="display: none;  width: 385px;" id="login1" type="post" >
    <fieldset>
