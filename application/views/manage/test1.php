        ...
        columns : [ [
            ...
            },
            {
                ...
                formatter:function(value){
                    return dictGetName('002',value);
                },
                editor:{type:'combobox',
                    options:{
                        url : 'dictParamAction!dictCombobox.action?paramLevel=002',
...
<div region="north" border="false" title="搜索条件" style="height: 85px;overflow: hidden;" align="left">
    <form id="searchForm">
        <table>
            <tr>
                <td>用户账号<input name="cname" style="width:100px;" />&nbsp;</td>
                <td>真实名称<input name="realname" style="width:100px;" />&nbsp;</td>
                <td>所属部门<select class="easyui-combotree" url="jeecgGroupAction!ctrlTree.action" name="org"/>&nbsp;</td>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td>修改时间<input name="cmodifydatetimeStart" class="easyui-datetimebox" editable="false" style="width: 100px;" />至<input name="cmodifydatetimeEnd" class="easyui-datetimebox" editable="false" style="width: 100px;" />&nbsp&nbsp<a href="javascript:void(0);" class="easyui-linkbutton" onclick="_search();">搜索</a>&nbsp&nbsp<a href="javascript:void(0);" class="easyui-linkbutton" onclick="cleanSearch();">取消</a></td>
            </tr>
        </table>
    </form>
</div>
