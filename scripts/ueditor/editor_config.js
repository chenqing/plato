...
(function () {
  ...
  //  URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    URL = "http://localhost/ci/scripts/ueditor/"
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","undo","insertunorderedlist","insertorderedlist","justifyleft","justifycenter","justifyright","justifyjustify","bold","italic","underline","strikethrough","removeformat","insertimage","attachment","horizontal","backcolor","forecolor","fontsize","fontfamily","highlightcode","blockquote","redo"]]
    ...
    //,lang:'zh-cn'
        ...
        //initialContent:'cpis high 起来'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
